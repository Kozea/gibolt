...
def upgrade():
    ...
    op.create_table('milestone_value',
    sa.Column('report_id', sa.Integer(), nullable=False),
    ...
    op.create_table('checklist_value',
    sa.Column('report_id', sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_table('checklist_value')
    op.drop_table('milestone_value')
    op.drop_table('attendee')
    op.drop_table('agenda_value')
    # ### end Alembic commands ###
