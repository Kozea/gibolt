...
// export const createCircle = createdCircle => ({
//   type: 'CREATE_CIRCLE',
...
//   const allErrors = []
//   const state = getState()
//   const { results } = state.organisation
//   results.results = state.organisation.results
//   const datas = {
//     name: results.organisation.circle_name,
//     purpose: results.organisation.circle_purpose,
//     domain: results.organisation.circle_domain,
//     accountabilities: results.organisation.circle_accountabilities,
//   }
//   try {
//     response = await fetch('api/circles', {
//       method: 'POST',
...
//     })
//   } catch (e) {
//     allErrors.push('Erreur pendant la récupération des données du label')
//   }
//   if (response.status >= 200 && response.status < 300) {
//     try {
//       circleJson = await response.json()
//     } catch (e) {
//       allErrors.push('La réponse ne contient pas de json')
//     }
//     // dispatch(createRepositoryLabels(circleJson.object))
//   } else {
//     allErrors.push(
//       `Erreur [${response.status}] ${response.statusText} pour le label `
//     )
