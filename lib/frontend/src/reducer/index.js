  ...
  switch (action.type) {
    case 'ADD_CHECK':
      return {
        results: {
          ...state.results,
          form_checklist: !state.results.form_checklist,
        },
      }
    case 'ADD_IND':
      return {
        results: {
          ...state.results,
          form_indicator: !state.results.form_indicator,
        },
      }
    default:
  ...
  switch (action.type) {
    case 'EDIT_CIRCLE':
      return {
        ...
        // markvalue: state.results.circle_accountabilities
      }
...
const markvalue = (state = initial.markvalue, action) => {
  switch (action.type) {
    case 'CHECK_ACC':
      return { markvalue: action.content }
    default:
      return state
  }
}
